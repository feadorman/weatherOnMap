    ...
    return (
        <div className={s.this__map}>
            <div className={s.top__block}>
                ...
                <a className={s.this__link} href="/week-statistics/">Istanbul, {Math.floor(weather.weather.weather.id)} °C</a>
                ...
                <a className={s.this__link} href="/week-statistics/">Samsun,  °C</a>
                </div>
